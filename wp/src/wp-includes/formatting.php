 ...
 */
function _wptexturize_pushpop_element($text, &$stack, $disabled_elements): void
{
...
function wp_rel_callback($matches, $rel)
{
    ...
    if (! empty($atts['href'])) {
        if (in_array(strtolower(wp_parse_url($atts['href']['value'], PHP_URL_SCHEME)), [ 'http', 'https' ], true)) {
 ...
 * @since 5.1.0
 */
function wp_init_targeted_link_rel_filters(): void
{
    $filters = [
        'title_save_pre',
        'content_save_pre',
 ...
 * @since 5.1.0
 */
function wp_remove_targeted_link_rel_filters(): void
{
    $filters = [
        'title_save_pre',
        'content_save_pre',
 ...
 * @since 4.2.0
 */
function print_emoji_styles(): void
{
 ...
 * @access private
 */
function _print_emoji_detection_script(): void
{
    $settings = [
        /**
