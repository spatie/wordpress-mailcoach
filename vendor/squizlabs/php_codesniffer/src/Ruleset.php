...
class Ruleset
{
     ...
     */
    private function processRule($rule, $newSniffs, $depth = 0): void
    {
        $ref = (string) $rule['ref'];
        $todo = [$ref];
     ...
     * @return void
     */
    public function registerSniffs($files, $restrictions, $exclusions): void
    {
        $listeners = [];
     ...
     * @return void
     */
    public function setSniffProperty($sniffClass, $name, $value): void
    {
