...
abstract class Tokenizer
{
     ...
     * @return void
     */
    public function replaceTabsInToken(&$token, $prefix = ' ', $padding = ' ', $tabWidth = null): void
    {
        $checkEncoding = false;
        if (function_exists('iconv_strlen') === true) {
            $checkEncoding = true;
     ...
     * @return void
     */
    private function createTokenMap(): void
    {
     ...
     * @return void
     */
    private function createParenthesisNestingMap(): void
    {
        $map = [];
        for ($i = 0; $i < $this->numTokens; $i++) {
     ...
     * @see    recurseScopeMap()
     */
    private function createScopeMap(): void
    {
        if (PHP_CODESNIFFER_VERBOSITY > 1) {
