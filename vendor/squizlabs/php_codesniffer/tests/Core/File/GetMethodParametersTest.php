...
class GetMethodParametersTest extends AbstractMethodUnitTest
{
     ...
     * @return void
     */
    public function testArrayHint(): void
    {
        $expected = [];
        $expected[0] = [
            'name' => '$var',
     ...
     * @return void
     */
    public function testSingleDefaultValue(): void
    {
        $expected = [];
        $expected[0] = [
            'name' => '$var1',
     ...
     * @return void
     */
    public function testSelfTypeHint(): void
    {
        $expected = [];
        $expected[0] = [
            'name' => '$var',
     ...
     * @return void
     */
    public function testBitwiseAndConstantExpressionDefaultValue(): void
    {
        $expected = [];
        $expected[0] = [
            'name' => '$a',
     ...
     * @return void
     */
    public function testPHP8UnionTypesWithSpreadOperatorAndReference(): void
    {
        $expected = [];
        $expected[0] = [
            'name' => '$paramA',
     ...
     * @return void
     */
    public function testPHP8UnionTypesSimpleWithBitwiseOrInDefault(): void
    {
        $expected = [];
        $expected[0] = [
            'name' => '$var',
     ...
     * @return void
     */
    public function testPHP8ConstructorPropertyPromotionNoTypes(): void
    {
        $expected = [];
        $expected[0] = [
            'name' => '$x',
     ...
     * @return void
     */
    public function testPHP8ConstructorPropertyPromotionWithTypes(): void
    {
        $expected = [];
        $expected[0] = [
            'name' => '$x',
     ...
     * @return void
     */
    public function testPHP8ConstructorPropertyPromotionAndNormalParam(): void
    {
        $expected = [];
        $expected[0] = [
            'name' => '$promotedProp',
     ...
     * @return void
     */
    public function testPHP81ConstructorPropertyPromotionWithReadOnly(): void
    {
        $expected = [];
        $expected[0] = [
            'name' => '$promotedProp',
     ...
     * @return void
     */
    public function testPHP8ConstructorPropertyPromotionGlobalFunction(): void
    {
        $expected = [];
        $expected[0] = [
            'name' => '$x',
     ...
     * @return void
     */
    public function testPHP8ConstructorPropertyPromotionAbstractMethod(): void
    {
        $expected = [];
        $expected[0] = [
            'name' => '$y',
     ...
     * @return void
     */
    public function testCommentsInParameter(): void
    {
        $expected = [];
        $expected[0] = [
            'name' => '$param',
     ...
     * @return void
     */
    public function testParameterAttributesInFunctionDeclaration(): void
    {
        $expected = [];
        $expected[0] = [
     ...
     * @return void
     */
    public function testPHP81IntersectionTypesWithSpreadOperatorAndReference(): void
    {
        $expected = [];
        $expected[0] = [
            'name' => '$paramA',
     ...
     * @return void
     */
    private function getMethodParametersTestHelper($commentString, $expected): void
    {
