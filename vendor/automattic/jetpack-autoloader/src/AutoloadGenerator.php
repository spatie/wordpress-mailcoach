...
class AutoloadGenerator
{
    ...
    protected function parseAutoloadsType(array $packageMap, $type, PackageInterface $mainPackage)
    {
        ...
        foreach ($packageMap as $item) {
            ...
            if (in_array($type, [ 'psr-4', 'psr-0' ], true) && isset($autoload[ $type ]) && is_array($autoload[ $type ])) {
     ...
     */
    private function removeLegacyFiles($outDir): void
    {
        $files = [
     ...
     */
    private function writeAutoloaderFiles($outDir, $suffix): void
    {
     ...
     */
    private function writeManifests($outDir, $processedAutoloads): void
    {
